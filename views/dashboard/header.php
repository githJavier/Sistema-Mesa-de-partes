                ...
                <div class="dropdown">
                    ...
                    <div id="userMenu" class="user-menu">
                        <div class="user-info text-center">
                            <div class="user-name"><?= htmlspecialchars($nombres) ?></div>
                            <div class="user-doc"><?= htmlspecialchars($retipo_docu) ?>: <?= htmlspecialchars($usuario) ?></div>
                        </div>
                        <hr>
                        <a href="../../cerrarSesion.php" class="btn-logout" id="cerrarSesion">
