    ...
    <body class="tema-background">
        <div class="container d-flex justify-content-center align-items-center min-vh-100">
            <div class="card shadow p-4 card-container">
                <h2 class="text-center mb-5 txt-titulo"><i class="fa-light fa-file"></i> GESTIÓN ARBITRAL</h2>
                <form id="loginForm">
                    <div class="mb-4">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="documento" placeholder="USUARIO" aria-label="DNI" maxlength="8" name="documento">
                        </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="button" class="btn w-75 btnIngresarSistema" id="btnLogin" name="btnLogin" value="Ingresar" onclick="enviarFormAdmin()">Login</button>
                    </div>
                </form>
                ...
                <div class="d-flex justify-content-around mt-3 txt-small">
                    <small><a href="registro.php" class="text-decoration-none">Mesa virtual documentos</a></small>
                </div>
            </div>
        </div>
