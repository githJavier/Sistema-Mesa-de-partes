<?php
require_once __DIR__ . '/../../../shared/models/mensajesAyuda.php';
require_once __DIR__ . '/../../../shared/models/ayuda.php';
require_once __DIR__ . '/../../../shared/utils/log_config.php';
session_start();

class GetResponderMensajeAdmin {
    private $objAyuda;
    ...
    public function validarBoton($nombreBoton) {
        return isset($_POST[$nombreBoton]) && $_POST[$nombreBoton] == "AbrirChatResponderMensajeAdmin";
    }
