...
include_once("../../../shared/models/tipoDocumento.php");
include_once("../../../shared/models/usuario.php");
include_once("../../../shared/models/area.php");
include_once("../../../shared/utils/supabaseUploader.php");
include_once("../../../shared/utils/log_config.php");
