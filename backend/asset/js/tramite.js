...
function enviarFormTramite() {
    ...
    $.ajax({
        type: "POST",
        url: "../../services/tramites/IngresarTramite/controlIngresarTramite.php",
        data: formData,
        processData: false,
        contentType: false,
        dataType: "json",
...
function derivarTramite() {
    ...
    $.ajax({
        type: "POST",
        url: "../../services/tramites/ResolverTramite/DerivarTramite/controlDerivarTramite.php",
        data: formData,
        processData: false,
        contentType: false,
        dataType: "json",
...
function archivarTramite() {
    ...
    $.ajax({
        type: "POST",
        url: "../../services/tramites/ResolverTramite/ArchivarTramite/controlArchivarTramite.php",
        data: formData,
        processData: false,
        contentType: false,
        dataType: "json",
