...
function enviarForm() {
    if(validarFormulario()){
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/CrearRemitente/controlCrearRemitenteAdmin.php",
            data: {
...
function consultarDocumento() {
    ...
    $.ajax({
        type: "POST",
        url: "../../services/usuarios/CrearRemitente/consultaDocumento.php",
...
function cargarDatosRemitente(id) {
    fetch('../../services/usuarios/Ajustes/controlAjustesRemitente.php?id=' + encodeURIComponent(id))
...
function enviarFormEditar() {
    if(validarFormularioEdicion()){
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Ajustes/controlFormajusteRemitente.php",
            data: {
                id: id,
                email: email,
                telefono: telefono,
...
function enviarFormEliminar() {
    ...
    $.ajax({
        type: "POST",
        url: "../../services/usuarios/Ajustes/controlEliminarRemitente.php",
        data: {
            id: id,
