...
function cargarFormularioTramite() {
    ...
    verificarSesionRemitente(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/tramites/IngresarTramite/controlFormIngresarTramite.php",
            dataType: "json",
...
function cargarformularioAyuda(){
    ...
    verificarSesionRemitente(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/maestros/Ayuda/controlFormAyuda.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarFormularioSeguimiento(){
    ...
    verificarSesionRemitente(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/tramites/SeguimientoTramite/controlFormSeguimientoTramite.php",
            dataType: "json",
            success: function(response) {
                ocultarSpinner();
                if (response.flag == 1) {
...
function cargarAjustesDatos() {
    ...
    verificarSesionRemitente(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Ajustes/controlFormAjustarDatos.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarformularioMensaje(){
    ...
    verificarSesionRemitente(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Mensaje/controlFormMensaje.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarDepartamentos(datoDepartamento = null, datoProvincia = null, datoDistrito = null) {
    $.ajax({
        type: "POST",
        url: "../../services/usuarios/Ajustes/controlAjustesUbicacion.php",
        dataType: "json",
        success: function(response) {
...
function verificarSesionRemitente(callback) {
    fetch("../../shared/utils/verificarSesionRemitente.php")
        .then(res => res.json())
        .then(data => {
