...
function enviarForm() {
    if(validarFormulario()){
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Administracion/controlCrearUsuario.php",
            data: {
...
function enviarFormEditar() {
    if(validarFormularioEdicion()){
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Ajustes/controlFormajusteUsuario.php",
            data: {
                id: id,
                tipoDocumento: tipoDocumento,
                numeroDocumento: numeroDocumento,
...
function cargarDatosUsuario(id) {
    fetch('../../services/usuarios/Ajustes/controlAjustesUsuario.php?id=' + encodeURIComponent(id))
...
function cargarDatosCrearUsuario() {
    fetch('../../services/usuarios/Ajustes/controlAjustesUsuario.php')
        .then(response => response.json())
        .then(data => {
            if (data.success) {
                const areas = data.data.areas;
...
function enviarFormEliminar() {
    ...
    $.ajax({
        type: "POST",
        url: "../../services/usuarios/Ajustes/controlEliminarUsuario.php",
        data: {
            id: id,
