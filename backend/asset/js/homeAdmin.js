...
function cargarformularioAdministracionRemitentes() {
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Administracion/controlAdministracionRemitentes.php",
            dataType: "json",
...
function cargarformularioAdministracionUsuarios() {
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Administracion/controlAdministracionUsuarios.php",
            dataType: "json",
            success: function(response) {
                ocultarSpinner();
                if (response.flag == 1) {
...
function cargarformularioAdministracionAreas() {
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Administracion/controlAdministracionAreas.php",
            dataType: "json",
            success: function(response) {
                ocultarSpinner();
                if (response.flag == 1) {
...
function cargarformularioAdministracionDocumentos() {
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Administracion/controlAdministracionDocumentos.php",
            dataType: "json",
            success: function(response) {
                ocultarSpinner();
                if (response.flag == 1) {
...
function cargarformularioConsultarTramitesArchivados(){
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/tramites/Consultar/controlFormConsultarTramitesArchivados.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarformularioConsultarTramitesDerivados(){
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/tramites/Consultar/controlFormConsultarTramitesDerivados.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarformularioRecibirTramitesExternos(){
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/tramites/RecibirTramiteExterno/controlFormRecibirTramiteExterno.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarformularioRecibirTramitesInternos(){
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/tramites/RecibirTramiteInterno/controlFormRecibirTramiteInterno.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarformularioResolverTramites(){
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/tramites/ResolverTramite/controlFormResolverTramite.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarformularioIngresarTramite(){
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/tramites/IngresarTramiteUsuario/controlFormIngresarTramiteUsuario.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function cargarformularioMensaje(){
    ...
    verificarSesion(() => {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Mensaje/controlFormMensajeAdmin.php",
            dataType: "json",
            success: function(response){
                ocultarSpinner();
                if(response.flag == 1){
...
function verificarSesion(callback) {
    fetch("../../shared/utils/verificarSesion.php")
        .then(res => res.json())
        .then(data => {
