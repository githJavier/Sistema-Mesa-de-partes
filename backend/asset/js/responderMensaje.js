...
if (typeof window.intervaloChat === "undefined") {
    window.habilitarPollingChat = true;
    ...
    function enviarMensaje() {
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Mensaje/EnviarMensaje/controlEnviarMensaje.php",
            data: {
                mensaje: mensaje,
    ...
    window.intervaloChat = setInterval(() => {
        if (!window.habilitarPollingChat) {
            clearInterval(window.intervaloChat);
            delete window.intervaloChat;
            return;
        }

        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Mensaje/RecibirMensaje/controlRecibirMensaje.php",
            data: { 
                idAyuda: window.idAyuda,
