function cargarFormularioArchivarTramite(codigo_tramite, asunto, num_documento){
    $.ajax({
        type: "POST",
        url: "../../services/tramites/ResolverTramite/ArchivarTramite/controlFormArchivarTramite.php",
        data: {
...
function cargarFormularioDerivarTramite(codigo_tramite, asunto, num_documento, cod_detalle_tramite){
    $.ajax({
        type: "POST",
        url: "../../services/tramites/ResolverTramite/DerivarTramite/controlFormDerivarTramite.php",
        data: {
            codigo_tramite: codigo_tramite,
            asunto: asunto,
            num_documento: num_documento,
