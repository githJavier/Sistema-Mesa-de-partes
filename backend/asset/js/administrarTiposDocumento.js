function cargarDatosTipoDocumento(id) {
    fetch('../../services/usuarios/Ajustes/controlAjustesTipoDocumento.php?id=' + encodeURIComponent(id))
...
function enviarFormEditar() {
    if(validarFormularioEdicion()){
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Ajustes/controlFormAjusteTipoDocumento.php",
            data: {
                id: id,
...
function enviarFormCrear() {
  if (validarFormularioCreacion()) {
    ...
    $.ajax({
      type: "POST",
      url: "../../services/usuarios/Ajustes/controlCrearTipoDocumento.php",
      data: {
        tipoDocumento: tipoDocumento,
        abreviatura: abreviatura,
        btnCrear: "Crear"
...
function enviarFormEliminar() {
    ...
    $.ajax({
        type: "POST",
        url: "../../services/usuarios/Ajustes/controlEliminarTipoDocumento.php",
        data: {
            id: id,
