function cargarDatosArea(id) {
    fetch('../../services/usuarios/Ajustes/controlAjustesArea.php?id=' + encodeURIComponent(id))
...
function enviarFormEditar() {
    if(validarFormularioEdicion()){
        ...
        $.ajax({
            type: "POST",
            url: "../../services/usuarios/Ajustes/controlFormAjusteArea.php",
            data: {
                id: id,
                area: area,
                btnEditar: "Editar"
...
function enviarFormCrear() {
  if (validarFormularioCreacion()) {
    ...
    $.ajax({
      type: "POST",
      url: "../../services/usuarios/Ajustes/controlCrearArea.php",
      data: {
        area: area,
        btnCrear: "Crear"
      },
...
function enviarFormEliminar() {
    ...
    $.ajax({
        type: "POST",
        url: "../../services/usuarios/Ajustes/controlEliminarArea.php",
        data: {
            id: id,
